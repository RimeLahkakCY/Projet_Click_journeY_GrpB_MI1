...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $dataFile = 'data_reservations.json';
...
<body>
    <div class="container">
        ...
        <h2> Modifier les Informations de Réservation :</h2>
        <p style="color:red"> N'oubliez pas d'enregistrer les modifications avant de valider ! </p>
        </br>
        ...
        <div class="action-buttons">
            ...
            <a class="btn btn-primary" href="main.php">Retour à l'Accueil</a>
			<?php
